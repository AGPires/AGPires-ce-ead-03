...
<html>
    ...
    <body>
        <center>
            <img src=
            <?php echo '"'.$linkimagem.'"' ?> title=
            <?php echo '"'.$nomefacul.'"' ?> alt='Faculdade' width="420">
            <h1>
                <?php echo $decl ?></h1>
        </center>
        <hr>
        <p>
            Declaramos, para os devido fins, que 
            <?php echo $aluno.' '.$nao ?> concluiu satisfatoriamente as atividades da 
            disciplina 
            <?php echo $disciplina ?> do Curso 
            <?php echo $curso ?>.
            <br>
            <br>
            Segue o desempenho de 
            <?php echo $aluno ?>:
        </p>
        <br>
        <center>
            ...
            <p>
                ...
                <span class="pontos"><?php echo $notastotal?></span>
                pontos 
            </span>
         <center>
            <p>
            ...
            <p>
                ...
                <br>
                <?php echo $prof?> - Professor(a)
            </p>
            <p>
                ____________________________________ 
                <br>
                <?php echo $coord?> - Coordenador(a) 
            </p>
         </center>
		</center>
	</body>
